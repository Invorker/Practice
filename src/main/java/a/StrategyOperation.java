...
//import com.qit.lp.automation.function.test.util.*;
...
//        ObjectMapper mapper = new ObjectMapper();
//        //@RequestParam("code") MultipartFile files, @RequestParam("name") String name,
...
//     * @return 响应结果
//     */
//    public String httpClientUploadFile(MultipartFile files, Map<String, Object> map, String remote_url) {
...
//            builder.addBinaryBody("code", files.getInputStream(), ContentType.MULTIPART_FORM_DATA, fileName);// 文件流
